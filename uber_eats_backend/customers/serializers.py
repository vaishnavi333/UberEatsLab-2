...
class CustomerSerializer(serializers.ModelSerializer):
    ...
    name = serializers.CharField(source='user.username', read_only=True)  # Fetch username from User
    email = serializers.EmailField(source='user.email', read_only=True) # Fetch email from User
