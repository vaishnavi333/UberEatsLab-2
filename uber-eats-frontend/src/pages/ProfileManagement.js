    ...
    return (
        <div>
            ...
            <Form >
                ...
                <Image style={{ maxHeight: '300px', width: 'auto' }}
                src={profilePicture instanceof File ? URL.createObjectURL(profilePicture) : `http://localhost:8000${profilePicture || '/default-avatar.png'}`}fluid
                />
