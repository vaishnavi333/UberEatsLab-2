          ...
          <Image
            src={
              profilePicture instanceof File
                ? URL.createObjectURL(profilePicture) // Show the uploaded image
                : profilePicture // Use the existing image URL from the server
                  ? `http://localhost:8000${profilePicture}` // Construct the image URL
